...
import config_store
from data_fetcher import (  # noqa: F401  (re-export 保持兼容)
    CACHE_DB,
    _close_http_client,
    _ensure_daily_table,
    _fetch_kline_sina,
    ...
    _sina_symbol,
    fetch_qfq_tencent,
    fetch_realtime,  # 保持 se.fetch_realtime 向后兼容
    get_daily_data,
)
...
from strategy_conditions import (  # noqa: E402,F401  (re-export 保持兼容)
...
# 全部内置策略 id(由注册表派生,单一事实来源)
BUILTIN_STRATEGY_IDS = {sid for sid, _name, _fn in BUILTIN_REGISTRY}
