...
TOOLS = [
    ...
    # ---------- 玉姐全市场实时扫描 ----------
    {
        ...
        "function": {
            ...
            "description": "全市场玉姐评分实时扫描(耗时1-3分钟)。用 daily 表已缓存数据对全市场4700+只股票重新打分,返回 Top N 高分股。用户说'扫描整个市场/全市场玉姐/实时玉姐评分/重新扫一遍/按玉姐选股'时调用。与 get_yujie_picks(盘前09:25扫描结果)区别:这是实时重跑全市场评分。",
            "parameters": {
                "type": "object",
                "properties": {
